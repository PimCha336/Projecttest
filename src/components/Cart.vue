<template>
  ...
  >
    ...
    <b-button v-if="!product.cart" @click="add(product)"  href="#" variant="primary">Add to Cart</b-button>
     <b-button v-if="product.cart" @click="add(product)" :disabled="product.cart" href="#" variant="warning">Product added to Cart </b-button>
  </b-card>
    </b-col>
  </b-row>
...
export default {
  ...
  data(){
    ...
    {
        id:2,
        img:'@/assets/uc149.jpg',
        name:'Pack 300+ free 25 uc ',
        price:149.00,
        cart:false,
        quantity:1
    },
    {
        id:3,
        img:'@/assets/uc299.jpg',
        name:'Pack 600+ free 60 uc',
        price:299.00,
        cart:false,
        quantity:1
    ...
    {
        id:4,
        img:'@/assets/uc749.jpg',
        name:'Pack 1500+ free 300 uc',
        price:749.00,
        cart:false,
        quantity:1
    ...
    {
        id:5,
        img:'@/assets/uc1600.jpg',
        name:'Pack 3000+ free 850 uc',
        price:1600.00,
        cart:false,
        quantity:1
    },
    {
        id:6,
        img:'@/assets/uc3000.jpg',
         name:'Pack 6000+ free 210 uc',
        price:3000.00,
        cart:false,
        quantity:1
